...
<head>
    ...
    <title>Redaksi Login — Zverse</title>
...
<div class="w-full max-w-sm">
    <div class="text-center mb-8">
            ...
            <div class="leading-none text-left">
                ...
                <span class="text-[10px] font-semibold uppercase tracking-[0.25em] text-slate-500">Redaksi</span>
            </div>
        </a>
        <p class="text-gray-500 text-sm">Portal Redaksi</p>
    </div>
    <div class="bg-gray-900 rounded-2xl border border-gray-800 p-8">
        <h2 class="text-white text-xl font-bold mb-6 text-center">Masuk sebagai Redaksi</h2>
        @if($errors->any())
        ...
        <form action="{{ route('redaksi.login.post') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="username" value="{{ old('username') }}" required autofocus
                       class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
        ...
        <p class="text-gray-600 text-xs text-center mt-4">Demo: <span class="text-gray-400 font-mono">dian / redaksi123</span></p>
    </div>
