...
'email' => 'rizky@zverse.id',
        ...
        $raka = User::create([
            'name'         => 'Raka Aditya',
            'username'     => 'raka',
            'display_name' => 'Raka Aditya',
'email' => 'raka@zverse.id',
            'password'     => 'pewarta123',
        ...
        $indri = User::create([
            'name'         => 'Indri Sari',
            'username'     => 'indri',
            'display_name' => 'Indri Sari',
'email' => 'indri@zverse.id',
            'password'     => 'pewarta123',
            'avatar_color' => 'from-pink-500 to-fuchsia-400',
            'role'         => 'pewarta',
        ]);
        ...
        $tegar = User::create([
            'name'         => 'Tegar Kusuma',
            'username'     => 'tegar',
            'display_name' => 'Tegar Kusuma',
'email' => 'tegar@zverse.id',
            'password'     => 'redaksi123',
            'avatar_color' => 'from-green-500 to-emerald-400',
            'role'         => 'redaksi',
        ]);
        ...
        $udin = User::create([
            'name'         => 'Udin Saputra',
            'username'     => 'udin',
            'display_name' => 'Udin Saputra',
'email' => 'udin@zverse.id',
            'password'     => 'redaksi123',
            'avatar_color' => 'from-indigo-500 to-blue-400',
            'role'         => 'redaksi',
        ]);
        ...
        $jaya = User::create([
            'name'         => 'Jaya Pratama',
            'username'     => 'jaya',
            'display_name' => 'Jaya Pratama',
'email' => 'jaya@zverse.id',
            'password'     => 'redaksi123',
            'avatar_color' => 'from-teal-500 to-cyan-400',
            'role'         => 'redaksi',
        ]);
        ...
        $articles = [
            ...
            [
                ...
                'author'       => $rizky->display_name,
                'author_id'    => $rizky->id,
                'read_time'    => '8 menit',
                'rating'       => 9.2,
                'featured'     => true,
                'tags'         => ['RPG', 'Open World', '2025', 'Gaming'],
                'reviewed_by'  => $tegar->display_name,
            ],
            [
                ...
                'author'       => $raka->display_name,
                'author_id'    => $raka->id,
                'read_time'    => '6 menit',
                'rating'       => 9.5,
                'featured'     => false,
                'tags'         => ['Nintendo', 'Zelda', 'Review', 'Switch 2'],
                'reviewed_by'  => $udin->display_name,
            ],
            [
